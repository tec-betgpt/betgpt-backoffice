      ...
      <form v-else class="space-y-6" @submit.prevent="submitForm()">
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <div class="flex items-center space-x-2 md:col-span-2">
            <input type="checkbox" id="customDomainEdit" v-model="form.customDomainEnabled" class="h-4 w-4 rounded border border-primary text-primary focus:ring-1 focus:ring-ring" />
