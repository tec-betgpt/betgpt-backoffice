  ...
  <Card v-else>
    <CardHeader class="py-4">
      <div class="flex justify-between items-center align-middle">
        <CardTitle>
          Números absolutos do dia
          <span class="font-normal text-muted-foreground">(entradas no segmento por atividade de depósito)</span>
        </CardTitle>
    ...
    <CardContent class="pt-6">
      ...
      <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-xs text-muted-foreground">
        <div class="flex items-start gap-2">
          ...
          <span><strong>Novos Clientes:</strong> FTD ocorrido neste dia.</span>
        </div>
        <div class="flex items-start gap-2">
        ...
        <div class="flex items-start gap-2">
          ...
          <span><strong>Retidos:</strong> depositaram neste dia já com histórico na janela anterior.</span>
        </div>
        <div class="flex items-start gap-2">
...
const chartName = 'daily-segment-entries'
