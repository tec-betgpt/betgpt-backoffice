...
const applyPreset = (preset: string) => {
  ...
  switch (preset) {
    ...
    case "yesterday": start = end.subtract({ days: 1 });   break;
    case "7days":     start = end.subtract({ days: 7 });   break;
    case "14days":    start = end.subtract({ days: 14 });  break;
    case "28days":    start = end.subtract({ days: 28 });  break;
  }
...
<template>
  <Popover :open="popoverOpen">
    ...
    <PopoverContent class="w-full p-4" align="center">
      ...
      />
      <Button class="w-full mt-2" @click="handleCalendar">
        Aplicar
      </Button>
    </PopoverContent>
  </Popover>
