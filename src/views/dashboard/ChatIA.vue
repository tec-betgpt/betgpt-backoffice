      ...
      <CardContent class="flex justify-center items-center gap-4 p-4">
        ...
        >
          ...
          <CardContent class="flex flex-col gap-2">
            <Skeleton
              v-if="loading"
              class="py-6 w-full shadow-md transition-all"
            />
            <Badge
              v-else
              v-for="chat in chats"
        ...
        <div class="min-h-[600px] flex flex-1 flex-col justify-between gap-2">
          ...
          <div
            ...
            class="flex flex-1 flex-col overflow-y-auto gap-3 max-h-[500px] p-2"
          >
            <div
            ...
            >
              ...
              >
                <p class="sm:text-md text-xs font-medium break-words">
                  {{ message.content }}
                </p>
                <a
                  v-if="message.file"
            ...
            <Skeleton
              v-if="loading"
              class="p-5 mx-1 max-w-[80%] lg:max-w-[60%] shadow-md transition-all"
            />
            <div
  ...
  try {
    ...
    if (selectedChatId.value === chatId) {
      selectedChatId.value =
        chats.value.length > 0 ? chats.value[0].id.toString() : null;
    }
  } catch (error) {
