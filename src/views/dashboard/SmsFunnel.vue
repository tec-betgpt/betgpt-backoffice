...
useScreenContext(
  ...
  () => ({
    ...
    "broadcast_page": broadcastPages.value.current,
    "broadcast_last_page": broadcastPages.value.last,
    "broadcast_per_page": broadcastPerPage.value,
    "broadcast_order_by": broadcastOrderId.value || "",
    "broadcast_type_order": broadcastOrder.value ? "asc" : "desc",
    "broadcast_total": totalBroadcasts.value ?? 0,
    "campaign_sms_total": campaignsStats.value.sms,
    "campaign_clicks_total": campaignsStats.value.clicks,
    "campaign_ctr": campaignsStats.value.ctr,
    "broadcast_sms_total": broadcastsStats.value.sms,
    "broadcast_clicks_total": broadcastsStats.value.clicks,
    "broadcast_ctr": broadcastsStats.value.ctr,
    "clicks_total": totals.value.clicks_total,
    "ctr_total": totals.value.ctr_total,
    "campaign_search": JSON.stringify(searchCampaignValues.value),
    "broadcast_search": JSON.stringify(searchBroadcastValues.value),
  }),
  "/v1/sms-funnel"
);
</script>
